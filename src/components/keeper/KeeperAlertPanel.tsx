...
function alertStyle(type: KeeperAlertSeverity) {
...
function alertLabel(type: KeeperAlertSeverity) {
...
export function KeeperAlertPanel({ state, title = "Keeper Alerts" }: { state: ForgekeeperState; title?: string }) {
