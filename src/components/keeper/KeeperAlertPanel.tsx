import { getKeeperAlerts, type KeeperAlert } from "../../lib/keeper/keeperAlerts";

function alertStyle(type: KeeperAlert["severity"]) {
...
function alertLabel(type: KeeperAlert["severity"]) {
