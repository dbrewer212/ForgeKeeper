...
export const FoundryWorkers: Record<string, WorkerIdentity> = {
  foundryCore: {
    ...
    capabilities: [
      ...
      MeshCapabilities.skillCatalogRead,
      MeshCapabilities.experienceRead,
  ...
  foundryIntelligence: {
    id: "foundry-intelligence",
    name: "Foundry Intelligence",
    kind: "foundry-intelligence",
    description: "Intent interpretation, context assembly, reasoning, planning, governed skill selection, experience retrieval, and outcome evaluation. It never bypasses Mesh authority.",
    capabilities: [
      MeshCapabilities.meshReadState,
      MeshCapabilities.meshPublishEvent,
