...
export function FilamentView({ state }: { state: ForgekeeperState }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card title="Filament Inventory Census" right={<span className="text-xs text-slate-500">v0.1.1 · {state.storageStatus === "SQLite" ? "SQLite workshop database" : state.storageStatus}</span>}>
